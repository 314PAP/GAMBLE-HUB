       ...
       scores.slice(0, 5).forEach((record, idx) => {
         ...
         html += `
           <div style="padding: 6px 18px; margin: 2px 0; display: flex; justify-content: space-between; align-items: center;">
             ...
             <span class="font-bold text-[var(--neon-green)]" style="text-shadow: 0 0 5px var(--neon-green-glow);">${record.castka}&nbsp;<span aria-hidden="true" style="color: var(--neon-gold); font-size: inherit; vertical-align: middle;">🪙</span></span>
           </div>
         `;
       });
